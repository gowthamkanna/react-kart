          ...
          {productID !== 0 ? (
            <>
              ...
              <div className="col-md-6 col-sm-12">
                ...
                <p className="badge bg-success product-price">
                  <span className="strikked-text product-original-price">
                ...
                <hr />
                {currentProduct.StockLeft <= 5 &&
                currentProduct.StockLeft > 0 ? (
                  <p className="badge bg-success product-stock">
                    {" "}
                    only {currentProduct.StockLeft} left ..
                  </p>
                ) : null}
                      ...
                      <div className="card mb-2">
                        <div className="card-body">
                          <div className="row">
                            ...
                            <div className="col-md-6 col-sm-12">
                              <div className="float-end product-detail-rating">
