...
const SalesStatisticChart = loadable(() =>
	pMinDelay(import("./SalesStatisticChart"), 1000)
);

const SalesStatisticChart2 = loadable(() =>
	pMinDelay(import("./SalesStatisticChart2"), 1000)
);


const SalesStatisticTab = () => {
	return(
		<>
			<Tab.Container defaultActiveKey="Monthly">
				<div className="card">
					<div className="card-header border-0 flex-wrap">
						<h4 className="fs-20">Sales Statistic</h4>
					...
					<div className="card-body py-0">
						<Tab.Content>
							<Tab.Pane eventKey="Daily">
								<div id="SalesStatistic" className="Sales-1">
									<SalesStatisticChart />
								</div>
							</Tab.Pane>	
							<Tab.Pane eventKey="Weekly">
								<SalesStatisticChart2 />
							</Tab.Pane>	
...
export default SalesStatisticTab;